  ...
  export const box4 = () => {
      return (
            ...
            <Box>
              ...
              >
                <li style={{textAlign: 'left'}}>15 Web Developer Portfolios to Inspire You</li>
              </a>
              <a
                href="https://www.canva.com/learn/portfolio/"
                style={{ textDecoration: "none", color: "white" }}
              >
                <li style={{textAlign: 'left'}}>Awesome Portfolio with 20 Pro Tips</li>
              </a>
              <a
              ...
              >
                <h6>
                  <li style={{textAlign: 'left'}}>Top 12 Portfolios for Inspiration</li>
                </h6>
              </a>
            </Box>
    ...
    <>
          ...
          <li style={{display: 'flex'}}>
            ...
            src="https://images-na.ssl-images-amazon.com/images/I/51mEe0St6-L._SX258_BO1,204,203,200_.jpg" />
             Fullstack React <br/>
             By: Accomazzo Anthony (Author),<br/> Murray Nathaniel (Author), <br/>Lerner Ari (Author)
             </li>
        </Box>
        <Box backgroundColor='white' color='black'>
        <li style={{display: 'flex'}}>
            <Logo height='200px' src='https://images-na.ssl-images-amazon.com/images/I/41gYvqhm2yL.jpg' alt='' />
          </li>
        </Box>
        </>
    )
...
class Resources extends React.Component {
  ...
  render() {
    ...
    return (
        <div style={{backgroundColor: 'rgba(241, 241, 241, 0.979)'}}>
        <Header>
        <Nav
      ...
      onAdd={this.onAdd}
      editable={true} 
      widgets={this.state.widgets} layout={this.state.layout}/>
      </div>
